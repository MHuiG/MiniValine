...
- [Simple and lightweight (11.67 KB gzipped)](https://app.bundle-analyzer.com/gh/MiniValine/MiniValine).
...
**Because the original author violated the relevant provisions of the GPL-2.0 LICENSE, MiniValine will abandon GPL-2.0 or its later version agreement to use GPL-3.0 LICENSE, and will continue to open source.**
